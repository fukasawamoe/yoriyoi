...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actioncable>.freeze, ["= 7.0.7.1"])
  s.add_runtime_dependency(%q<activestorage>.freeze, ["= 7.0.7.1"])
  s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 7.0.7.1"])
  s.add_runtime_dependency(%q<actiontext>.freeze, ["= 7.0.7.1"])
