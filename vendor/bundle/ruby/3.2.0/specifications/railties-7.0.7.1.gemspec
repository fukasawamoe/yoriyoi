# -*- encoding: utf-8 -*-
# stub: railties 7.0.7.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<actionview>.freeze, ["= 7.0.7.1"])
end
